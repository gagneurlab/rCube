...
#' @name rCube-package
#' @docType package
#' @title RNA Rates in R
#' @author Leonhard Wachutka, Carina Demel, Julien Gagneur
#' @keywords package
NULL

#' The desginMatrix for the Quick-Start example in the vignette
#'
#' @name designMatrix
#' @docType data
#' @author Leonhard Wachutka, Carina Demel, Julien Gagneur
...
#' GENCODe annotated exons for MYC
#'
#' @name exampleExons
#' @docType data
#' @author Leonhard Wachutka, Carina Demel, Julien Gagneur
...
#' \code{rCubeExperiment} container for spike-ins including example read counts
#'
#' @name spikeinCounts
#' @docType data
#' @author Leonhard Wachutka, Carina Demel, Julien Gagneur
...
#' Labeling status of artificial spike-ins sequences
#'
#' @name spikeinLabeling
#' @docType data
#' @author Leonhard Wachutka, Carina Demel, Julien Gagneur
#' @keywords data
NULL
