...
Please note, the data set is downsampled due to size reasons, that's why fitting results are less acurate than when applied to multiple genes from deep-sequenced samples.
